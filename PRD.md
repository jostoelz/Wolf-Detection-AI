...
Ich folge dem gleichen Vorgehen wie mit dem Test-Datensatz durchgeführt. Das Modell erreicht mit einem YOLO v8m-Modell-Training bei 100 Epochen, 640 Pixeln, 32 Batches die folgenden Resultate: Precision = , Recall = , mAP50, mAP50-95 = . Das trainierte Modell ("pt"-Datei) kann <a href="https://kantonsschuleromanshorn-my.sharepoint.com/:f:/r/personal/jostoelz_ksr_ch/Documents/Privat/Maturaarbeit/Wolfs-Erkennung-AI/Data_sharing?csf=1&web=1&e=G6Jn56">hier</a> heruntergeladen werden.
