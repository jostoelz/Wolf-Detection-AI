...
Version 1: Ich folge dem gleichen Vorgehen wie mit dem Test-Datensatz durchgeführt. Das Modell erreicht mit einem YOLO v8m-Modell-Training bei 100 Epochen, 640 Pixeln, 32 Batches die folgenden Resultate: Precision = 0.96, Recall = 0.94, mAP50 = 0.96, mAP50-95 = 0.79. Das trainierte Modell ("pt"-Datei) kann <a href="https://kantonsschuleromanshorn-my.sharepoint.com/:f:/r/personal/jostoelz_ksr_ch/Documents/Privat/Maturaarbeit/Wolfs-Erkennung-AI/Data_sharing?csf=1&web=1&e=G6Jn56">hier</a> heruntergeladen werden.
<br>
...
= 0.8ms. Das Training der 70 Epochen wurden in 5.57 Stunden abgeschlossen. Das trainierte Modell ("pt"-Datei) kann <a href="https://kantonsschuleromanshorn-my.sharepoint.com/:f:/r/personal/jostoelz_ksr_ch/Documents/Privat/Maturaarbeit/Wolfs-Erkennung-AI/Data_sharing?csf=1&web=1&e=G6Jn56">hier</a> heruntergeladen werden. Es umfasst insgesamt 2384 Test-Bilder, 67398 Train-Bilder und 3275 Valid-Bilder. Ich hätte weitere 9867 Wolfs-Bilder, welche ich dem Datensatz für bessere Ergebnisse hinzufügen könnte. Diese müssten aber per Hand beschriftet werden, was zeitlich nicht mehr gereicht hat. 
